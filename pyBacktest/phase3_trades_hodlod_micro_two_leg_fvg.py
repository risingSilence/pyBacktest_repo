print("phase3_trades_hodlod_micro_two_leg_fvg.py - starting up...")
...
def run_phase3_micro_for_symbol(symbol: str):
    print(f"--- Processing Phase 3 (Micro Two Leg) for {symbol} ---")
...
def main():
    for sym in SYMBOLS:
        run_phase3_micro_for_symbol(sym)
